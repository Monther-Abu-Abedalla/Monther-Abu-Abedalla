...
class DioManagerSeconderBase {
  DioManagerSeconderBase._();
  static final DioManagerSeconderBase getInstance = DioManagerSeconderBase._();

  Dio? _dio;
  Dio init() {
    _dio = Dio(
      BaseOptions(
        baseUrl: ConstanceNetwork.secondaryBaseUrl,
