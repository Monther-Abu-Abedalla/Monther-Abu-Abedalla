...
class LeagueTableItem extends StatelessWidget {
  const LeagueTableItem({super.key});
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            GetBuilder<MatchDetailViewModel>(
              builder: (logic) {
                return Table(
                  ...
                  children: [
                    for (final standing in logic.standings?.standingRow ?? [])
                      ...buildTableRow(
                        standing: standing,
                        context: context,
                      ),
